...
zcat simplified.vcf.gz | awk -v outgroup=$outgroup_index_in_simplified_vcf -v outgroup_discard_index=$outgroup_discard_index '$outgroup==$outgroup_discard_index' | awk -v outgroup=$outgroup_index_in_simplified_vcf -v outgroup_discard_index=$outgroup_discard_index '$outgroup==$outgroup_discard_index' | awk -v outgroup=$outgroup_index_in_simplified_vcf -v outgroup_discard_index=$outgroup_discard_index 'BEGIN{
    OFS="\t"
